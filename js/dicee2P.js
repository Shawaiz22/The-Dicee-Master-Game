...
// setting default names if player name is null
...
// start game alert
alert(`Good luck ${player1} and ${player2}, the one who first reaches the position = 100, wins the game!`);
...
// calling playerTwo function on button click :

document.getElementById("btnP2").addEventListener("click",function(){

    if(document.querySelector(".turn2").classList[1]=="nonVisible"){
        alertSound.play();
    }
    else{
...
function playerMover1(astObsChecker1){
    ...
    for(let i=0;i<assets.length;i++){
        ...
        // game ends if the user scores 100
        if(score1>=100){
            gameEnd(score1,score2);
        }
             break;
...
// function after coming out of obstacle or asset animation
...
function gameEnd(myScore1, myScore2){
    ...
    setTimeout(()=>{
        ...
        if(myScore1>=100){
            ...
            document.querySelector(".startAndWinDiv").classList.remove("displayNone");
            document.querySelector(".startAndWin").innerHTML=`Congratulations, ${player1} has won the Match 🏆! <br> Press any key, or refresh to continue!`;
        }
            ...
            document.querySelector(".startAndWin").style.fontSize="4rem";
            document.querySelector(".startAndWinDiv").classList.remove("displayNone");
            document.querySelector(".startAndWin").innerHTML=`Congratulations, ${player2} has won the Match 🏆! <br> Press any key, or refresh to continue!`;
        }
...
if(score1<100 && score2<100){
    ...
    return "Do you want to restart the match?";
  };
}
